        ...
        <div className="mx-auto px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 2xl:px-12" style={{ maxWidth: '1920px', width: '100%' }}>
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="relative">
              {/* Main Logo */}
              <div className="relative w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg overflow-hidden group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 border-2 border-black/50">
                <img 
