  ...
  const mumbaiPlaces: Place[] = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?q=80&w=800&auto=format&fit=crop', // Modern office buildings
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=800&auto=format&fit=crop', // Modern business district
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=800&auto=format&fit=crop', // Modern residential towers
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?q=80&w=800&auto=format&fit=crop', // Modern high-rise buildings
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?q=80&w=800&auto=format&fit=crop', // Modern business area
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?q=80&w=800&auto=format&fit=crop', // Suburban business area
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?q=80&w=800&auto=format&fit=crop', // Lake view with buildings
    ...
    <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          {/* Navigation Buttons */}
          <button className="absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-white/90 backdrop-blur-sm hover:bg-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110">
            <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
          </button>
          <button className="absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-white/90 backdrop-blur-sm hover:bg-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110">
            <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex gap-6 overflow-x-auto scrollbar-hide px-4 pb-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            {mumbaiPlaces.map((place, index) => (
              <div
                ...
                className={`group relative flex-shrink-0 w-80 h-96 rounded-3xl overflow-hidden shadow-xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#a08efe]/30 cursor-pointer ${
                  hoveredPlace === place.id ? 'ring-2 ring-[#a08efe]/50' : ''
                }`}
                style={{
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => handleGetOffer(place.name)}
                      className="bg-orange-400 text-white px-3 py-1 rounded-full text-xs font-semibold hover:bg-blue-900 transition-colors duration-300"
                    >
                      Get Offer
                    </button>
                  </div>
