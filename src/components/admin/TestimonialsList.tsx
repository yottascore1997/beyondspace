  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(errorData.error || 'Failed to delete testimonial');
      }
    } catch (error) {
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1 bg-red-500 text-white text-xs rounded-lg hover:bg-red-600 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                      >
